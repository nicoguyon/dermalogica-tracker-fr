    ...
    <div className="space-y-6">
      ...
      <div className="bg-gray-900 dark:bg-white rounded-xl p-6">
        <div className="flex items-center">
          <Sparkles className="h-8 w-8 mr-3 text-white dark:text-gray-900" />
          <div>
            <h3 className="text-2xl font-bold text-white dark:text-gray-900">{products.length} nouveaux produits</h3>
            <p className="text-gray-400 dark:text-gray-500 text-sm">
              {selectedBrand ? `Marque: ${selectedBrand}` : 'Toutes marques confondues'}
            </p>
          </div>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
          ...
          <p className="text-sm text-gray-400 mt-1">Augmentez la période ou changez de marque</p>
        </div>
      ) : (
